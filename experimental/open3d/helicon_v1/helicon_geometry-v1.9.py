# 1 isosceles triangle, highlight intersections with semi-circle
...
def calculate_triangle_semicircle_intersections():
    # Calculate intersection points geometrically
    intersections = []

    # Left side intersections (approximate based on geometry)
    intersections.extend([
        [-0.866, -0.5, 0],  # With bottom semi-circle
        [-0.5, 0, 0],       # With left semi-circle
        [-0.5, 0.5, 0]      # With left semi-circle
    ])

    # Right side intersections (approximate based on geometry)
    intersections.extend([
        [0.866, -0.5, 0],   # With bottom semi-circle
        [0.5, 0, 0],        # With right semi-circle
        [0.5, 0.5, 0]       # With right semi-circle
    ])
...
def create_helicon_geometry():
    ...
    # [Previous geometry creation remains the same up to triangle]
    # Base square
    ...
    # [Rest of previous geometry creation remains the same]
    # Main circle
    ...
    # Add triangle-semicircle intersection points
    intersection_points = calculate_triangle_semicircle_intersections()
    for point in intersection_points:
        sphere = o3d.geometry.TriangleMesh.create_sphere(radius=0.03)  # Slightly larger radius
        sphere.translate(point)
        sphere.paint_uniform_color([1.0, 0.0, 1.0])  # Magenta color to distinguish
        geometries.append(sphere)

    # [Rest of the geometry creation remains the same]
    # Diagonal lines, grid lines, other intersection points, and harmonic ratio lines...

    # Original intersection points (smaller and yellow)
